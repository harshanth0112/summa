...
if __name__ == "__main__":
    orders_df = load_order_data(r'C:\Users\h6411\Desktop\Design project (2)\Design project\data\monthly_sales.csv')
    basket_sparse, product_names = preprocess_for_apriori(orders_df)
    frequent_itemsets = find_frequent_itemsets(basket_sparse, product_names, min_support=0.01)
    display_top_frequent_itemsets(frequent_itemsets, top_n=5)
